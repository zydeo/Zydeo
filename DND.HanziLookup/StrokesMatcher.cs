...
namespace DND.HanziLookup
{
    ...
    public class StrokesMatcher
    {
        ...
        private bool searchTraditional;
        private bool searchSimplified;
        ...
        private bool running;	// flag to prematurely stop processing if necessary
        ...
        {
            double AVG_SUBSTROKE_LENGTH = 0.33;	// an average length (out of 1)
            ...
            this.scoreMatrix = new double[scoreMatrixDimension][];
            for (int i = 0; i != scoreMatrix.Length; ++i)
                scoreMatrix[i] = new double[scoreMatrixDimension];
        ...
        static double CORRECT_NUM_STROKES_BONUS = 0.1; // max multiplier bonus if characters has the correct number of strokes
        static int CORRECT_NUM_STROKES_CAP = 10;  // characters with more strokes than this will not be multiplied
        ...
        private CharacterMatch compareToNext(int inputStrokeCount, int inputSubStrokeCount, int subStrokesRange)
        {
            ...
            char character = this.compareTo.Character;
            int type = this.compareTo.CharacterType;
            int compareStrokeCount = this.compareTo.StrokeCount;
            int compareSubStrokeCount = this.compareTo.SubStrokeCount;
        ...
        static private double SKIP_PENALTY_MULTIPLIER = 1.75; // penalty mulitplier for skipping a stroke
        ...
        {
            double[] inputDirections = this.inputCharacter.Directions;
            double[] inputLengths = this.inputCharacter.Lengths;
